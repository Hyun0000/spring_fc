...
public class RequestMessage {
	// header 정보 포함, 요청 Message 전부를 출력해 주는 method
	@RequestMapping("/requestMessage")
	public void main(HttpServletRequest request) throws Exception {
// ============================================================================================
	// 1. request line
	String requestLine = request.getMethod();       // 결과값 : GET 또는 POST
	requestLine += " " + request.getRequestURI();   // 결과값 : /ch2/requestMessage
	
	String queryString = request.getQueryString();  // 결과값 : year=2021&month=10&day=1
	requestLine += queryString == null ? "" : "?"+queryString;  
	requestLine += " " + request.getProtocol();     // 결과값 : HTTP/1.1
...
// ============================================================================================
	...
	if(CONTENT_LENGTH > 0) { // body가 있을 때만 출력
...
// [실행결과1] - GET 요청 ==> header만 있고 body는 없다.
...
// [실행결과2] - POST 요청 ==> header와 body 모두 있다.
...
// accept-encoding:gzip, deflate, br
// accept-language:ko-KR,ko;q=0.9,en-US;q=0.8,en;q=0.7
//                           <--- empty line [header와 body를 구분해준다.]
